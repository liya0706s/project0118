...
INSERT INTO `reviews` (`id`, `title`, `subti`, `review`, `img`) VALUES
(1, '程式設計是我最喜歡的課!!!', '因為程式設計課，我學會做自己的小遊戲。', '透過學習程式設計課，我會做自己的遊戲，我喜歡分享給我的同學。', ''),
(2, '我喜歡透過寫程式表達想說的事情', '這會是我想一直學下去的課程!', '寫程式可以做遊戲、寫故事、做卡片和動畫...還可以訓練我邏輯思考。', '');
