...
(4, '123456學習程式語言還可以讓我更聰明，因為我要思考怎麼讓我的遊戲或故事運作', '654321我學到了邏輯和問題解決的能力，這對我以後的學習也很有幫助。', '我最喜歡的部分是創造我的角色，我可以自己選顏色、形狀，還可以加上可愛的表情和動作。然後，我可以讓我的角色跳來跳去，或者做一些有趣的動作。有一次，我做了一個小貓咪，然後讓它跳上跳下，好像在跳舞一樣！', 'slide5.png', 0),
