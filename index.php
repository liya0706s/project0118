...
<body>
	<main>
		...
		<!-- carousel with words start -->
		<div class="container marketing">
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading fw-normal lh-1">61688First featurette heading. <span class="text-body-secondary">It’ll blow your mind.</span></h2>
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					<h2 class="featurette-heading fw-normal lh-1">1234Oh yeah, it’s that good. <span class="text-body-secondary">See for yourself.</span></h2>
